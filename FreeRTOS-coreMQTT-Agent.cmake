...
if (NOT DEFINED COREMQTT_AGENT_DIR)
    set(COREMQTT_AGENT_DIR "${CMAKE_CURRENT_LIST_DIR}/lib/coreMQTT-Agent")
endif()

add_library(coreMQTTAgent STATIC)
include("${COREMQTT_AGENT_DIR}/mqttAgentFilePaths.cmake")
...
target_link_libraries(coreMQTTAgent 
    coreMQTT 
    pico_stdlib
